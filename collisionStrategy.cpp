...
void RectangularCollisionStrategy::draw() const {
  IOmod::
  getInstance().writeText("Strategy: Rectangular", {255, 0, 0, 255}, 500, 30);
}
...
void MidPointCollisionStrategy::draw() const {
  IOmod::
  getInstance().writeText("Strategy: Distance", {255, 0, 0, 255} ,500, 30);
}
...
void PerPixelCollisionStrategy::draw() const {
  IOmod::
  getInstance().writeText("Strategy: Per-Pixel ", {255,0,0,255},500, 30);
}
